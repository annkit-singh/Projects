...
public class MainProject extends JFrame implements ActionListener {
      MainProject(){
        ...
        ImageIcon ic =  new ImageIcon(ClassLoader.getSystemResource("Icons/E2.jpg"));
        Image i3 = ic.getImage().getScaledInstance(1400, 800,Image.SCALE_DEFAULT);
...
//        setFont(new Font("Bodonic Classic",Font.BOLD,100));
